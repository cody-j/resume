...
\newcommand{\experience}[5]{%  % Title, Company, Date, Highlights, Blurb
    \textbf{\large #1} {\small\textbar{}} \raisebox{0ex}{\small{#2}} \hfill \raisebox{0.1ex}{\small\textbf{#3}}\\%
    {\footnotesize{#5}}\vspace{0.4em}%
...
}{A component library for Excel built on modern array features}
...
}{Enterprise retail and logistics platform managing 400+ distributed retail locations}
...
}{Agricultural intelligence platform combining satellite imagery with precision farming technology}
...
}{Payment data studio with cross-platform aggregation}
